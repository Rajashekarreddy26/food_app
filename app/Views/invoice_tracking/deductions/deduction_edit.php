 ...
 * Edit Deduction
 */ 
$id_val = isset($deduction['id']) ? $deduction['id'] : (isset($_POST['id']) ? $_POST['id'] : '');
$name_val = isset($deduction['name']) ? $deduction['name'] : set_value('name');
?>
<div class="modal-dialog">
	<div class="modal-content">
		<form method="post" id="edit_deduction" onsubmit="return false">
			<?= csrf_field(); ?>
			<input type="hidden" name="id" value="<?= $id_val; ?>">
			<div class="modal-header">
				<h5 class="modal-title fs-5">Edit Deduction</h5>
			...
			<div class="modal-footer">
                <button type="submit" onclick="updateDeduction()" class="btn btn-success btn-sm"><i class="bi bi-plus-square"></i>&nbsp;Update</button>
