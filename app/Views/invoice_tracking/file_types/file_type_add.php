...
<div class="modal-dialog">
	<div class="modal-content">
		<form method="post" id="add_file_type" onsubmit="return false">
			<?= csrf_field(); ?>
			<div class="modal-header">
				<h5 class="modal-title fs-5">Add File Type</h5>
			...
			<div class="modal-footer">
                <button type="submit" onclick="insertFileType()" class="btn btn-success btn-sm"><i class="bi bi-plus-square"></i>&nbsp;Add</button>
