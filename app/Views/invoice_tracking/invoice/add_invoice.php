...
$ctg_type = (isset($_POST['$category ']) and !empty($_POST['$category'])) ? $_POST['$category'] : '';
...
/*if (isset($ctg_type) && $ctg_type == 3) {
    $labour = INV_PARAMS['labour_cess'];
} elseif (isset($ctg_type)) {
    $labour = 0;
}*/
        ...
        <div class="modal-body">
            <form id="add-inv-frm">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                        <input type="text" name="basic" id="basic" class="form-control" value="<?= set_value('basic') ?>" placeholder="Basic After Mobilization Deduction( &#8377; )" readonly>
