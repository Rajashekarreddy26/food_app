...
?>
<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-end">Mobilization Advance:</label>
    <div class="col-sm-7">
        <input type="text" id="mobilizationAdv" class="form-control" value="<?= $mobil_adv_amt ?>" disabled readonly>
    </div>
</div>

<div class="row mb-3">
    <label class="col-sm-3 col-form-label text-end">Remaining Mobilization Advance:</label>
    <div class="col-sm-7">
        <input type="text" id="mobilizationAdvAvailable" class="form-control" value="<?= $mobil_adv_avail_amt ?>" disabled readonly>
    </div>
</div>
...
<div class="row mb-3">
    ...
    <div class="col-sm-7">
        <input type="text" id="mobilizationPer" class="form-control" value="<?= $mobil_adv_per ?>" disabled readonly>
    </div>
</div>
