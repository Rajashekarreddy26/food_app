 ...
 */
// print "<pre>"; print_R($mobil_adv); exit;
// $mobil_adv = (isset($invoice_data['mobilization_adv']) AND $invoice_data['mobilization_adv'] > 0) ? $invoice_data['mobilization_adv'] : 0;
// $mobil_adv_avi = (isset($invoice_data['mobilization_adv_available']) AND $invoice_data['mobilization_adv_available'] > 0) ? $invoice_data['mobilization_adv_available'] : 0;
...
$tax_type = (isset($invoice_data['tax_type']) and !empty($invoice_data['tax_type'])) ? $invoice_data['tax_type'] : "";
                            ...
                            <div class="col-sm-8 col-xs-12">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="table-responsive">
                                            <table class="table table-borderless">
                                                <tbody>                                                    
                                                    <tr>
                                                        <td width="200">Invoice Amount ( &#8377;, &#36;, &#163;, &#8364; )</td>
                                                        <td width="1%">:</td>
                                                        <td class="text-end"><?= displayNumber($invoice_data['fx_invoice_amount'], 2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Currency Type</td>
                                                        <td>:</td>
                                                        <td class="text-end"><?= (isset($currencies[$invoice_data['currency']]['name']) ? $currencies[$invoice_data['currency']]['name'] :  '' ).' ( ' . (isset($currencies[$invoice_data['currency']]['symbol']) ? $currencies[$invoice_data['currency']]['symbol'] : '') . ' )'; ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Exchange Rate</td>
                                                        <td>:</td>
                                                        <td class="text-end"><?= displayNumber($invoice_data['ex_rate'], 2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Basic After Mobilization Deduction(&#8377;)</td>
                                                        <td>:</td>
                                                        <td class="text-end"><?= displayNumber($basic, 2); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="table-responsive">
                                            <table class="table table-borderless">
                                                <tbody>
                                                    <tr>
                                                        <td class="text-end">Mobilization Advance (&#8377;)</td>
                                                        <td>:</td>
                                                        <td class="text-end"><?= displayNumber(isset($mobil_adv['mobilization_adv']) ? $mobil_adv['mobilization_adv'] : 0,2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-end">Remaining Mobilization Advance (&#8377;)</td>
                                                        <td width="1%">:</td>
                                                        <td class="text-end" width="100"><?= displayNumber(isset($mobil_adv['mobilization_adv_available']) ? $mobil_adv['mobilization_adv_available'] : 0,2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-end">Mobilization Percentage</td>
                                                        <td>:</td>
                                                        <td class="text-end"><?= displayNumber($invoice_data['mobilization_per'], 2); ?>(&#37;)</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-end">Mobilization Deduction (&#8377;)</td>
                                                        <td>:</td>
                                                        <td class="text-end"><?= displayNumber($invoice_data['mobilization_amount'], 2); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <div class="table-responsive"> 
                                    <table class="table table-bordered table-hover table-striped table-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th width="25%">Invoice Amount Before GST</th>
                                                <td width="25%" class="text-end"><span id="inv-b"><?= displayNumber($invoice_data['invoice_amount'], 2) ?></span></td>
