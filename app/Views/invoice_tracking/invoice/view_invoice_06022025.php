                            ...
                            <div class="col-sm-8 col-xs-12">
                                            ...
                                            <table class="table table-borderless">
                                                <tbody>                                                    
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td class="text-end"><?= displayNumber($invoice_data['invoice_amount'], 2); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Currency Type</td>
                                                        <td>:</td>
                                ...
                                <div class="table-responsive"> 
                                    <table class="table table-bordered table-hover table-striped table-sm">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th width="25%">Basic After Mobilization Deduction</th>
