	...
	<div class="modal-content">
		<form method="post" id="add_location" onsubmit="return false">
			...
			<div class="modal-header">
				<h5 class="modal-title fs-5">Add Location</h5>
			...
			<div class="modal-footer">
                <button type="submit" onclick="insertLocation()" class="btn btn-success btn-sm"><i class="bi bi-plus-square"></i>&nbsp;Add</button>
