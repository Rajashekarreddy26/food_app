 ...
 * Edit Payment Type
 */ 
$id_val = isset($payment_type['id']) ? $payment_type['id'] : (isset($_POST['id']) ? $_POST['id'] : '');
$name_val = isset($payment_type['name']) ? $payment_type['name'] : set_value('name');
?>
	...
	<div class="modal-content">
		<form method="post" id="edit_location" onsubmit="return false">
			...
			<div class="modal-header">
				<h5 class="modal-title fs-5">Edit Payment Type</h5>
			...
			<div class="modal-footer">
                <button type="submit" onclick="updatePaymentType()" class="btn btn-success btn-sm"><i class="bi bi-plus-square"></i>&nbsp;Update</button>
