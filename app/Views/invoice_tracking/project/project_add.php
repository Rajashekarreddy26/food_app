                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
          	  		  	<div class="row">
          	  		  		...
          	  		  		<div class="col-md-5 col-sm-6 col-xs-12">
          	  		  			<div class="mb-3">
          	  		  			  	<label for="contract_val" class="form-label mb-0"><small>Contract Value [USD,PONDS,EUROS]</small>&nbsp;<span class="text-danger">*</span>&nbsp;:&nbsp;</label>
          	  		  			  	<div class="input-group input-group-sm">
          	  		  		...
          	  		  		<div class="col-md-3 col-sm-6 col-xs-12">
          	  		  			<div class="mb-3">
          	  		  				...
          	  		  				<select class="form-select form-select-sm" name="currency" id="currency">
                                            ...
                                            ?>
                                        <option value="<?= $value['id']; ?>" <?php if (set_value('currency') == $value['id']) { echo "selected"; } ?>><?= $value['name']; ?> (<?= html_entity_decode($value['symbol']); ?>)</option>  
          	  		  					<? } ?>
          	  		  				</select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="mb-0">
                                    <label for="mobilization_adv" class="form-label mb-0">Mobilization Balance&nbsp;<span class="text-danger">*</span>&nbsp;:&nbsp;</label>
                                        <input type="text" class="form-control form-control-sm text-end" id="mobilization_adv" name="mobilization_adv" value="<?= set_value('mobilization_adv'); ?>" placeholder="Please Enter Mobilization Amount &#8377 ">
                                    <span class="text-danger"><?= validation_show_error('mobilization_adv'); ?></span>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <div class="mb-0">
                                    <label for="mobilization_per" class="form-label mb-0">Mobilization Percentage&nbsp;:</label>
                                    <input type="text" id="mobilization_per" name="mobilization_per" class="form-control form-control-sm text-end" value="<?= set_value('mobilization_per'); ?>" placeholder="Please Enter Mobilization Percentage">
                                    <span class="text-danger"><?= validation_show_error('mobilization_per'); ?></span>
                                </div>
                            </div>                            
          	  		  	</div>                        
                    </div>
