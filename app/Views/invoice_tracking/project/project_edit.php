...
$mobilization_val = isset($project_details['mobilization_adv']) ? $project_details['mobilization_adv'] : set_value('mobilization_adv');
$mobilization_adv_avail = isset($project_details['mobilization_adv_available']) ? $project_details['mobilization_adv_available'] : set_value('mobilization_adv_available');
$mobilization_per = isset($project_details['mobilization_per']) ? $project_details['mobilization_per'] : set_value('mobilization_per');
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="mb-3">
                                    <label for="name" class="form-label mb-0">Mobilization Balance&nbsp;<span class="text-danger">*</span>&nbsp;:&nbsp;</label>
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control text-end" id="mobilization_val" name="mobilization_adv" value="<?= $mobilization_val; ?>"  placeholder="Please Enter Contract value">
                                    </div>
                                    <span class="text-danger"><small><?= validation_show_error('mobilization_adv'); ?></small></span>
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-12 col-xs-12">
                                <div class="mb-3">
                                    <label for="name" class="form-label mb-0">Mobilization Percentage&nbsp;:</label>
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control text-end" id="mobilization_per" name="mobilization_per" value="<?= $mobilization_per; ?>"  placeholder="Please Enter Mobilization Percentage">
                                    </div>
                                    <span class="text-danger"><small><?= validation_show_error('mobilization_per'); ?></small></span>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="mb-3">
                                    <label for="name" class="form-label mb-0">Remaining Mobilization Balance&nbsp;<span class="text-danger">*</span>&nbsp;:&nbsp;</label>
                                    <div class="input-group input-group-sm">
                                        <input type="text" class="form-control text-end" id="mobilization_adv_avail" name="mobilization_adv_available" value="<?= $mobilization_adv_avail; ?>"  placeholder="Please Enter Contract value">
                                    </div>
                                    <span class="text-danger"><small><?= validation_show_error('mobilization_adv_available'); ?></small></span>
                                </div>
                            </div>
          	  		  	</div>
                    </div>
