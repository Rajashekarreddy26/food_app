            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="mb-0">
                                <div class="form-view-name">Mobilization Balance</div>
                                <div class="form-view-value"><?= displayNumber($project_info['mobilization_adv'],2); ?></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="mb-0">
                                <div class="form-view-name">Remaining Mobilization Balance</div>
                                <div class="form-view-value"><?= displayNumber($project_info['mobilization_adv_available'],2); ?></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="mb-0">
                                <div class="form-view-name">Mobilization Percentage</div>
                                <div class="form-view-value"><?= displayNumber($project_info['mobilization_per'],2); ?></div>
                            </div>
                        </div>
                    </div>                                        
                </div>
