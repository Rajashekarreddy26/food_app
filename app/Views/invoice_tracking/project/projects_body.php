...
<div class="clearfix">	
	...
	<div class="float-end d-flex align-items-center">
		<div class="me-1">
			<button type="button" class="btn btn-sm btn-primary" onclick="exportProject('<? echo $rows; ?>', '1', '<? echo $sort_by; ?>', '<? echo $sort_order; ?>')"><i class="bi bi-upload"></i>&nbsp;Export</button>
...
<div class="table-responsive freeze-table mt-2 printable">
	<table class="table table-bordered table-hover table-striped table-sm">
		<thead>
			...
			<tr class="align-middle">
				...
				<!-- <th class="text-end" nowrap>Mobilization Amount</th> -->
			</tr>
		</thead>
		<tbody>
			<tr>
			...
			if($projects){
				...
				<tr>
					...
					<? //<td nowrap class="text-end"><?= ($value['mobilization_adv'] > 0) ? displayNumber($value['mobilization_adv'],2) : ''; ?></td>
